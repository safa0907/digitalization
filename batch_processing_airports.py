...
import sys
import overpass
from osm_airports import get_osm_airport
import fiona
...
#Export Edge Raster
        ...
        edges = cv2.Canny(blur, 100, 200, 3, L2gradient=True)
...
#Clip Edge polyline To Airport Feature
        arcpy.analysis.Clip(r"D:\Input_images\correct_phase1_output\Lines_Edges_USA_SanFran_merged_4326.shp", r"D:\Input_images\SynthaaS_Aircraft\Feature_Edges_USA_SanFran_merged_4326.shp", r"C:\Users\sridene\Documents\ArcGIS\Projects\MyProject\MyProject.gdb\Lines_Edges_USA_SanFran_merg1", None)
        arcpy.analysis.PairwiseClip(r"D:\Input_images\correct_phase1_output\Lines_Edges_USA_SanFran_merged_4326.shp", r"D:\Input_images\SynthaaS_Aircraft\Feature_Edges_USA_SanFran_merged_4326.shp", r"C:\Users\sridene\Documents\ArcGIS\Projects\MyProject\MyProject.gdb\Lines_Edges_USA_SanFran_merg2", None)